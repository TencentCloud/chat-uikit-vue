...
const userProfile = ref<IUserProfile | Record<string, any>>({});
// current edit value
const currentEditProfile = ref<IUserProfile | Record<string, any>>({
...
TUIStore.watch(StoreName.USER, {
  userProfile: (userProfileData: IUserProfile) => {
    ...
    (currentEditProfile.value as any) = { avatar, nick, selfSignature, gender, birthday };
...
function changeCurrentEditProfile(key: keyof IUserProfile, value: any) {
  if (Object.prototype.hasOwnProperty.call(currentEditProfile.value, key)) {
    (currentEditProfile.value[key] as any) = value;
  }
}
