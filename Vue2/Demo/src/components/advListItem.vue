<template>
  <div class="adv-list-item">
    <div class="show-box" @click="showEvent">
      ...
      <span class="name">{{ item?.name && TUITranslateService.t(`${item?.name}`) }}</span>
    </div>
    <div class="show-box hover-box" @click="hoverEvent">
      <label class="img-box">
        <img :src="item?.link" alt="">
      </label>
      <span class="name">{{ item?.detail && TUITranslateService.t(`${item?.name}`) }}</span>
      <span class="name">{{ item?.detail && TUITranslateService.t(`${item?.detail}`) }}</span>
    </div>
  </div>
</template>
