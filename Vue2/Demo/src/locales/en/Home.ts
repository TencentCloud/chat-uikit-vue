const Home = {
  ...
  "我们为您默认提供了一位“示例好友”和一个“示例客服群”您不用额外添加好友和群聊就可完整体验腾讯云 IM 单聊、群聊的所有功能。": "We provide a Sample Friend and a Sample Customer Service Group by default, so that you can fully try out all the features of one-to-one chat and group chat of Tencent Cloud IM without adding additional friends or groups.",
  ...
  "出生年月": "Birthday",
  "编辑资料": "Edit profile",
  "关于腾讯云IM": "About Tencent Cloud IM",
  "退出登录": "Log out",
  "隐私条例": "Privacy Policy",
  "用户协议": "User Agreement",
  "免责声明": "Disclaimers",
  ...
  "IM（“本产品”）是由腾讯云提供的一款测试产品，腾讯云享有本产品的著作权和所有权。本产品仅用于功能体验，不得用于任何商业用途。依据相关部门监管要求，严禁在使用中有任何色情、辱骂、暴恐、涉政等违法内容传播。": "Instant Messaging (IM) is a demo product provided by Tencent Cloud, and Tencent Cloud retains its copyright and ownership. This product is for trying out features, but not for commercial use. To follow regulatory requirements of the authority, audio and video-based interactions performed via IM will be recorded and archived throughout the whole process. It is strictly prohibited to disseminate any pornographic, abusive, violent, sensitive and other noncompliant content.",
  "同意": "Agree",
  "取消": "Cancel",
  "注销": "Cancel",
  "关闭": "close",
  "开启": "open",
  "关于腾讯云·通信": "About Tencent Cloud IM",
  "消息": "message",
  "通讯录": "contact",
  "个人中心": "Profile",
  "已读回执": "Read receipt",
